...
print ("Vällkommen till läxa eller spel? ") #Spel Titel

sleep (2)

print ("du har 3 timmar kvar innan du behöver läga ner dig för att sova och du har NO prov imorgon. kommer du använda resten av din tid för att plugga för provet eller kommer du spela fortnite")
...
if (answer == failure_ending):
    print ("Efter att ha haft en intensiv forre session inatt, lägger du dig på sängen och sover för natten. Dagen efter misslyckas du hårt med provet och får ett F i kursen")
